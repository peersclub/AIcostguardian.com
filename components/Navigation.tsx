...
export default function Navigation() {
  ...
  // Simplified navigation for dashboard page
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link href="/" className="flex items-center">
              ...
              <span className="ml-2 font-bold text-xl">AICostGuardian</span>
            </Link>

            {/* Right Side Actions for Dashboard */}
            <div className="flex items-center gap-3">
              {/* Quick Links */}
              <Link href="/ai-cost-calculator" className="p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg transition-colors">
