    ...
    <div className="min-h-screen bg-gray-950 relative overflow-hidden">
      ...
      <section className="relative overflow-hidden">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-900/20 text-blue-300 border border-blue-500/30 rounded-full text-sm font-medium mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"
                className="px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-lg hover:from-blue-700 hover:to-blue-600 transition-colors font-medium inline-flex items-center gap-2"
              >
                Schedule Demo
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {trustedBy.map((company, index) => (
                <div key={index} className="text-center">
                  <div className="h-12 flex items-center justify-center text-gray-400 font-medium">
                    {company}
                  </div>
                </div>
              ))}
      ...
      {/* Stats Section */}
      <section className="py-16 bg-gradient-to-br from-gray-900/50 to-gray-800/50 backdrop-blur-xl border-y border-gray-700 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-lg font-medium mb-1 text-gray-300">{stat.label}</div>
      ...
      <section className="py-20 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl font-bold text-white mb-4">Enterprise-Ready Features</h2>
            <p className="text-lg text-gray-300">Everything you need to manage AI costs at scale</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: index * 0.1 }}
                className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 backdrop-blur-xl rounded-xl p-6 border border-gray-700 hover:border-blue-500/50 transition-colors"
              >
