  ...
  try {
    ...
    const metadata = {
      ...
      defaultModels: [
        ...
        { value: 'claude-3.5-sonnet', label: 'Claude 3.5 Sonnet', provider: 'claude', description: 'Excellent for coding and analysis' },
        { value: 'claude-3.5-haiku', label: 'Claude 3.5 Haiku', provider: 'claude', description: 'Fast and efficient' },
        { value: 'claude-3-opus', label: 'Claude 3 Opus', provider: 'claude', description: 'Most capable Claude model' },
        { value: 'claude-3-sonnet', label: 'Claude 3 Sonnet', provider: 'claude', description: 'Balanced performance and cost' },
